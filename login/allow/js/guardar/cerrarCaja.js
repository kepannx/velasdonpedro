                    ...
                    function (isConfirm) {
                        if (isConfirm) {
                        	...
                        	$.ajax({
									...
									type: 'POST',
									dataType: 'JSON',
									data: { valorEnEfectivo: ""+valorEnEfectivo.value+"", 
                          valorEnDocumentos: ""+valorEnDocumentos.value+"", 
                          totalEnSistema: ""+totalEnSistema.value+"", 
                          idCierreCaja: ""+idCierreCaja.value+"", 
                          valorGastosEgresos: ""+valorGastosEgresos.value+""
                        },
