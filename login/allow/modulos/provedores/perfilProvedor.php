...
if (is_numeric($consultaComun->decrypt($_SESSION['IDPROVEDOR'], publickey))==NULL) {
...
$breadcrumb = array(0 => provedor, 1=> perfilProvedor);
?>
    ...
    <div class="container-fluid">      
      ...
      <!--Inicio del cuerpo  -->
        <div class="row white-box"> 
          <div class="col-md-12">
             <div class="col-md-6">
                <h2><i class="fa fa-fort-awesome"></i> <?php  echo perfilProvedor;?> <span id="nombreProvedorTitulo"></span></h2>
             </div>
          </div>
                  ...
                  <div class="sttabs tabs-style-flip">
                    ...
                    <div class="content-wrap">
                      <section id="section-flip-1">
                        <h2>Datos Básicos Provedor</h2>
                          ...
                          <div class="col-md-12" align="center">
                                <button type="button" id="actualizarPerfilProvedor" class="btn btn-success"> <i class="fa fa-check-circle"></i> Actualizar Datos </button>
                          </div>
                      </section>
                      ...
                      <section id="section-flip-2">
                        <h2> <i class="fa fa-book"></i> Historial de Compras</h2>
...
<script src="<?php echo PATH ?>js/acciones/customPerfilProvedores.js" type="text/javascript" charset="utf-8" async defer></script>
