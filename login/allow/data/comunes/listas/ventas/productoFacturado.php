  ...
  <div class="table-responsive">
	<h2> <i class="fa fa-list"></i> Productos Facturados</h2>
		...
		<?php
				...
				$consultaFacturas->listaImeisFactura($datoFactura["idFactura"]);
		?>
		...
		<div class="col-md-6">
			...
			<div class="row sales-report">
              ...
              <div class="<?php if($datoFactura["estadoFactura"]=='en credito')
              	...
              	<?php
              			if ($datoFactura["valorIncremento"]>0) {
              				# Cuando hay un incremento bancario...
              				?>
              	<h2 class="text-right">Venta Neta</h2>
                <h1 class="text-right text-success m-t-20">$<?php echo number_format($datoFactura["valorFactura"]); ?></h1>
                <h2 class="text-right">Total Comisión Bancaria</h2>
                <h1 class="text-right text-success m-t-20">$<?php echo number_format($datoFactura["valorIncremento"]); ?></h1>
                 <h2 class="text-right">Total Factura</h2>
                <h1 class="text-right text-success m-t-20">$<?php echo number_format($datoFactura["valorFactura"]+$datoFactura["valorIncremento"]); ?></h1>
