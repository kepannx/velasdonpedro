...
<form action="" name="clientForm" method="POST" id="formulario" data-toggle="validator">
  <div class="white-box">
        ...
        <div class="col-md-4">
          <label class="col-md-5 control-label">Fecha Factura</label>
            <div class="input-group">
              <input type="text" name="fechaFacturaProvedor" id="fechaFacturaProvedor" class="form-control complex-colorpicker" readonly placeholder="mm/dd/yyyy" value="<?php echo date("m/d/Y") ?>" required>
...
<div class="panel-body nopaddingtop">
      ...
      <div class="row">
        <div class="col-sm-12" align="center">
          <button type="submit" class="btn btn-wide btn-primary btn-quirk mr5" id="save"> <i class="fa fa-save"></i>Facturame</button>
          <input type="hidden" name="tipoImpresion" value="tirilla">
        </div>
      </div>
      <hr>
    </div>
