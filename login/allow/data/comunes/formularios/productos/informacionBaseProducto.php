...
<div class="col-md-12" id="segundoRenglonCapaServicios" >
	<div class="col-md-4">
		<div class="form-group">
      		...
      		<div class="input-group col-md-12">
	        	<select id="categorias" class="form-control"  data-error="Debes asignarle una categoría" required >
	...
	<div class="col-md-4">
		<div class="form-group">
      		...
      		echo $datosProductoServicio['subCategoria'];
      			if ($datosProductoServicio['subCategoria']==NULL || $datosProductoServicio['subCategoria']==0) {
      				...
      				echo '<div class="input-group col-md-12"  id="subCat">
							'.$consultaInventario->selectSubCategorias($consultaInventario->encrypt($datosProductoServicio['categoria'], publickey), $consultaInventario->encrypt($datosProductoServicio['subCategoria'], publickey)).'
      					</div>';
      			} 
      		 ?>
