            ...
            <form action="#" class="form-horizontal" name="clientForm" method="POST">
              <div class="form-body">
                ...
                <!-- fila 1-->
                  ...
                  <!-- Fin fila 1-->
            <h2>
                <i class="fa fa-cubes"></i>¿Cuales fueron los productos que compraste?</h2>
                  <!-- fila 2-->
          <div class="col-md-12">
                <!-- LISTA  FACTURERO-->
          <div class="white-box">
            ...
            <div class="table-responsive">
              ...
              ?>
                  ...
                  <tr>
                    <input type="hidden" name="sku[]" value="<?php echo $sku[$n]; ?>">
                    <td><?php echo $sku[$n]; ?></td>
                    <input type="hidden" name="itemName[]" value="<?php echo $itemName[$n]; ?>">
                    <td align="left" ><?php echo $itemName[$n]; ?></td>
