  ...
  <div class="col-md-3 col-sm-12">
      <div class="form-group">
          ...
          <div class="input-group" id="nombreProvedor">
            ...
            <input type="text" class="typeahead form-control" id="provedor" placeholder="Dime como llamarás a este punto de venta"  autocomplete="off"  data-error="Necesito que me digas quien es el provedor" max="100" required>
          </div>
  ...
  <div class="col-md-3 col-sm-12">
    <div class="form-group">
          ...
          <div class="input-group">
            ...
            <input type="text" class="form-control fechas" id="fechaFacturaProvedor" placeholder="Cuando lo compraste"  autocomplete="off" data-error="Debes darme el número de la factura"  required>
          </div>
        <div class="help-block with-errors"></div>
      </div>
  </div>
