            <table id="tablaComun" class="table table-striped">
                  <thead>
                    <tr>
                      ...
                      <th width="50px"><div style="text-align: center">Impuesto</div></th>
                  ...
                  <tbody>
                    ...
                    <div class="input-group">
                      ...
                      <td align="center">
                       <h3> <div class="text text-danger" id="impuesto_1">0%</div></h3>
                       <input type="hidden" id="tax_1" class="impuestos" value="0">
                      </td>
                      <td>
                ...
                <script src="../../js/acciones/itemsFacturacion.js"></script>