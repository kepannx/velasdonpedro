                    ...
                    function (isConfirm) {
                        if (isConfirm) {
                        	...
                        	$.ajax({
									...
									type: 'POST',
									dataType: 'JSON',
									data: { nombre: ""+nombre.value+"", identificacion: ""+identificacion.value+"", direccion: ""+direccion.value+"", telefonos: ""+telefonos.value+"", ciudad: ""+ciudad.value+"", email: ""+email.value+"", tipoUsuario: ""+tipoUsuario.value+ "", activada: ""+activada.value+ "", eps: ""+eps.value+ "", ips: ""+ips.value+ "", arp: ""+arp.value+ "", cajasCompensacion: ""+cajasCompensacion.value+ "", cesantias: ""+cesantias.value+ "", sueldoPromedio: ""+sueldoPromedio.value+ "", idUsuario: ""+idUsuario.value+ ""},
