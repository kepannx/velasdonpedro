...
$("#addItems").on('click',function(){
    ...
    html += '<td><input type="text" id="sku_'+i+'"  class="form-control autocompletar" data-type="sku" placeholder="SKU" autocomplete="off"></td>';
...
$(document).on('focus','.autocompletar',function(){
    ...
    $(this).autocomplete({
        ...
        select: function( event, ui ) {
            ...
            subtotal =  (1*((parseFloat(valor)*parseFloat(cantidad)))+(parseFloat(valor))*cantidad)
...
$(document).on('focus','.autocompletarItem',function(){
    ...
    $(this).autocomplete({
        ...
        select: function( event, ui ) {
            ...
            valor = names[3];
            valorIva= (valor*cantidad)*impuesto/100;
            subtotal =  (1*((parseFloat(valor)*parseFloat(cantidad))));
           $('#subTotal_'+id[1]).val(subtotal);
            $( "#porMayor_"+id[1]).on( "click", function() {
                productos();
                if ($('[id=porMayor_'+id[1]+']')[0].checked===true) {
