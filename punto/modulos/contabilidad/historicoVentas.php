...
$breadcrumb = array(0 => contabilidad, 1=> historialVentas);
?>
<!DOCTYPE html>
<html lang="es">
<head>
  ...
  <div id="page-wrapper">
    <div class="container-fluid">
      ...
      <div class="col-md-12 col-lg-12 col-sm-12">
          <div class="col-md-12">
            <h3><i class="fa fa-list-alt"></i> <?php echo historialVentas; ?> del <span id="fechaFactura"> de los últimos 30 días</span> </h3>
          </div>
          <!-- RÁNGO DE FECHAS-->
...
<script src="<?php echo PATH ?>/js/acciones/customHistoricoMovimientos.js"></script>
